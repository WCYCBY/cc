    ...
    var ms = {
        ...
        fillHtml:function(totalsubpageTmep,args){
            return (function(){
				...
				totalsubpageTmep += "<li><input type=\"number\" value=\""+gopage+"\" id=\"page_no\" min=\"1\" style=\"width:50px;text-align:center;float:left\" placeholder=\"页码\"></li>";
                ...
                //totalsubpageTmep +="<li><a href=\"javascript:;\" class=\"geraltTb_\" id=\"btnConfirm\">确定</a></li>";
                	...
                	totalsubpageTmep +="<span style='color:red;margin-right: 500px; font-weight:blod;'> 暂无数据 </span>";
                }
                totalsubpageTmep +="</ul>";
