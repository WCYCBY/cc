...
<body>
<form id="form" action="/mj/content/addContent.html" method="post" style="width:98%;padding-left:20px;">
	<input name="columsId" id="columsId" type="hidden" value="${columsId}"/>
		<table class="table table-hover definewidth m10">
				<tr>	
					...
					<td style="text-align: left">
							<input style="height: 30px;width: 200px" name="title" id="title" datatype="*" errormsg="标题不能为空"/>
				...
				<tr>	
					...
					<td style="text-align: left">
							<input name="status" type="radio" value="1" class="ace" checked="checked"><span class="lbl"></span>已发布
							<input name="status" type="radio" value="2" class="ace" checked="checked"><span class="lbl"></span>已屏蔽
					</td>
				</tr>
				<tr>	
					<td  style="text-align: left;" >
					...
					<td style="text-align: left">
							<input name="isTop" type="radio" value="1" class="ace" checked="checked"><span class="lbl"></span>是
							<input name="isTop" type="radio" value="2" class="ace" ><span class="lbl"></span>否
					</td>
				</tr>
