...
<body>
	<form id="form" class="form-horizontal" action="/auth/department/editDepartment.html"
		method="post" style="width:98%;padding-left:20px;">
		<input name="id" type="hidden" value="${authDepartment.id?c }"/>
		...
		<table class="table table-bordered table-hover definewidth" border="0" class="table table-bordered"
			...
			<tr>
				...
				<td style="text-align: left;line-height:35px;" width="84%">
					<div align="left"    style="padding-left:10px;">
						<input style="height: 30px;width: 200px" name="name" id="name" value="${authDepartment.name!''}" class="form-control"
			...
			<tr>
				...
				<td>
					<div align="left"   style="padding-left:10px;">
						<input style="height: 30px;width: 300px" id="description" name="description" value="${authDepartment.description!''}" datatype="checkDes" errormsg="工厂描述太长！"  class="form-control" />
